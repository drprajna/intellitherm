...
{
#if 0
// amomcu ÓÅ»¯£¬ ´¦ÀíÊý¾ÝÁ¿½Ï´óÊ±ÐèÒªµÈ´ýÊý¾Ý·¢ËÍÍê±ÏÔÙ·¢ËÍ£¬ ·ñÔòÊý¾Ý¾Í»á¶ªÊ§
// µ±È»£¬ Ò²¿ÉÒÔÔö´ó·¢ËÍ»º³åÇø£¬ µ«ÊÇÄÚ´æÓÐÏÞ£¬ Ö»ÄÜÕâÃ´¸ÉÁË     
  uint16 ret = 0;
  // ¸Ãº¯ÊýÑÓÊ±Ê±¼äÎª1ms£¬ ÓÃÊ¾²¨Æ÷²âÁ¿¹ý£¬ ÉÔÓÐÎó²î£¬ µ«Îó²îºÜÐ¡  --amomcu.com
  extern void simpleBLE_Delay_1ms(int times);

  // ²¨ÌØÂÊÔ½µÍ£¬ ÑÓÊ±ÒªÇóÔ½´ó£¬ Ïë´«ÊäÊý¾Ý¿ì£¬»¹ÊÇÒª115200²¨ÌØÂÊµÄ --amomcu.com
  // ÕâÀï²»ÄÜÑÓÊ±Ì«³¤Ê±¼ä£¬ ·ñÔò»á¶Ï¿ªÍøÂçÁ¬½ÓµÄ   --amomcu.com
