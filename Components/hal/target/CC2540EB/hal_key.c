...
#define HAL_KEY_SW_6_EDGE     HAL_KEY_RISING_EDGE //JFang, amomcu HAL_KEY_FALLING_EDGE
...
//  }
//#else
  //if (!(HAL_KEY_SW_6_PORT & HAL_KEY_SW_6_BIT))  //JFang, amomcu
  if ((HAL_KEY_SW_6_PORT & HAL_KEY_SW_6_BIT))    /* Key is active high */  
  {
    keys |= HAL_KEY_SW_6;
  }
...
//#endif
  ...
  //JFang
  /*NPI_WriteTransport(HAL_KEY_SW_6_PORT,1);
  NPI_WriteTransport(HAL_KEY_SW_6_BIT,1);
  NPI_WriteTransport(0,1);
  NPI_WriteTransport(0,1);
  */
